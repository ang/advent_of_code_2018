...
#                starting from a frequency of zero, the following changes would
#                occur:
#
...
def frequency_twice(input_filename)
  current_frequency = 0
...
def add_frequency(current_frequency, line)
  operator = line[0].to_sym
  value = line[1..-1].to_i

  current_frequency.send(operator, value)
end

puts frequency('input.txt')
puts frequency_twice('input.txt')
